...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-11-05 12:48`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9b7f6b14-59aa-4d8a-8f64-58e9df22679f.git
$ cd 9b7f6b14-59aa-4d8a-8f64-58e9df22679f
```
